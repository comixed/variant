...
import org.comixedproject.prestige.data.library.LibraryDatabase
import org.comixedproject.prestige.data.library.LibraryRepository
...
class AppViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        this.repository =
            LibraryDatabase.getDatabase(application, viewModelScope).libraryDao().let { dao ->
                LibraryRepository.getInstance(dao)
            }
    }
