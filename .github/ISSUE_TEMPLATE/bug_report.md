...
2. If the issue was found in a **pre-release** of Variant and not a release, please **do not file a bug**. Instead, send an email to the mailing list. 
...
**Desktop (please complete the following information):**
 ...
 - Platform OS (iPad, Android) and version
 - Platform hardware
